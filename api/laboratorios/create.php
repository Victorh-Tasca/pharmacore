...
$query = "INSERT INTO laboratorios (nome) VALUES (:nome)";
...
try {
    ...
    echo json_encode(["message" => "Laboratório criado com sucesso."]);
    ...
    if ($e->getCode() == '23505') {
        ...
        http_response_code(500);
        echo json_encode(["message" => "Não foi possível criar o laboratório."]);
    }
}
?>