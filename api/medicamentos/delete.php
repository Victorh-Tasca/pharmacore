...
try {
    ...
    if ($e->getCode() == '23503') {
        ...
        echo json_encode(["message" => "Não é possível excluir: este medicamento está sendo usado em um lote."]);
    } else {
        http_response_code(500);
        echo json_encode(["message" => "Não foi possível excluir o medicamento."]);
    }
}
?>